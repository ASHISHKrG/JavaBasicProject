...
public class SplitWords {
    ...
    public static void main(String[] args) {
		...
		*/
        ...
        System.out.printf("%.1f%n", Math.PI);  //no of digits after pi 1
        System.out.printf("%.2f%n", Math.PI);  //no of digits after pi 2
        System.out.printf("%.3f%n", Math.PI);
        System.out.printf("%.4f%n", Math.PI);
        System.out.printf("%.5f%n", Math.PI);  //no of digits after pi 5
    }
